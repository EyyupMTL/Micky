...
public final class ViewBarcodeScannerBinding implements ViewBinding {
  ...
  private ViewBarcodeScannerBinding(@NonNull View rootView,
  ...
  @NonNull
  public static ViewBarcodeScannerBinding inflate(@NonNull LayoutInflater inflater,
      @NonNull ViewGroup parent) {
    if (parent == null) {
      throw new NullPointerException("parent");
    }
    inflater.inflate(R.layout.view_barcode_scanner, parent);
    return bind(parent);
  }

  @NonNull
  public static ViewBarcodeScannerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ViewBarcodeScannerBinding(rootView, zxingBarcodeSurface, zxingStatusView,
          zxingViewfinderView);
    }
